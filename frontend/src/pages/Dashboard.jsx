    ...
    (async () => {
      ...
      try {
        if (user.user_type === 'admin') {
          ...
          const [b, vp] = await Promise.all([bookingsAPI.list(), vendorsAPI.myProfile().catch(() => ({ data: null }))]);
        ...
        <div className="main-content">
          ...
          <div className="page">
            ...
            <div className="stat-grid">
              ...
              <div className="stat-card"><div className="stat-icon" style={{ background: vendorProfile?.is_verified ? '#f0fdf4' : '#fff7ed' }}>{vendorProfile?.is_verified ? '✅' : '⏳'}</div><div className="stat-info"><p>Verification</p><h3 style={{ fontSize: 16, paddingTop: 4 }}>{vendorProfile?.is_verified ? 'Verified' : 'Pending'}</h3></div></div>
            </div>
            {!vendorProfile && (
            ...
            <div className="card">
              ...
              <div className="table-wrap">
                {bookings.length === 0 ? <div className="empty-state"><div className="icon">📭</div><p>No booking requests yet</p></div> : (
                  <table>
        ...
        <div className="page">
            ...
            <div className="card">
              ...
              {bookings.length === 0 ? (
                <div className="card-body">
                  ...
                  <button className="btn btn-secondary w-100" onClick={() => navigate('/discover')}>Find vendors →</button>
                </div>
              ) : (
                <div className="table-wrap">
                  <table>
          ...
          <div className="card" style={{ marginTop: 20 }}>
            <div className="card-body" style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              ...
              <button className="btn btn-secondary btn-lg" onClick={() => navigate('/discover')}>🗺 Find Vendors</button>
