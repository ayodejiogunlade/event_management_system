        ...
        <div className="page">
          <div className="flex justify-between items-center mb-3">
            <div>
              ...
              <p className="page-subtitle">{user.user_type === 'vendor' ? 'Incoming booking requests from event organizers' : 'Track the status of all your vendor bookings'}</p>
            </div>
          </div>
          ...
          {loading ? <div className="loading"><div className="spinner" /></div> :
            filtered.length === 0 ? (
              <div className="card"><div className="card-body"><div className="empty-state"><div className="icon">📋</div><p>No {filter === 'all' ? '' : filter} bookings found</p></div></div></div>
            ) : (
